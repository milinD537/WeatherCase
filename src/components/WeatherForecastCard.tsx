    ...
    return (
        <>
            <div className="grid gap-1 grid-cols-[0_repeat(3,1fr)] hover:grid-cols-[0.4rem_repeat(3,1fr)] transition-[grid-template-columns]">
                ...
                <div className="p-2 px-4 rounded-[0.3125rem] shadow-[0_8px_15.1px_hsl(0,1%,25%,10%)] backdrop-blur-[50px] useGPU | col-start-2 col-span-full | grid grid-cols-subgrid" style={{backgroundColor: cardBackgroundColor}}>
